...
const form = useForm({
    ...
    project_manager_phone: props.project.project_manager_phone,
    construction_manager: props.project.construction_manager,
    construction_manager_phone: props.project.construction_manager_phone,
    in_charge_to_pay: props.project.in_charge_to_pay,
    in_charge_to_pay_phone: props.project.in_charge_to_pay_phone,
