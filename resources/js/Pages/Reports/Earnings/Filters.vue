<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="container">
            ...
            <!-- General preview about profits - component -->
            <div v-if="data.length !== 0" class="tw-mt-5 tw-full">
                <EarningsReportsInfo :form="form" :data="data" />
            </div>
...
import EarningsReportsInfo from "../../../Components/EarningsReportsInfo.vue";
...
const title = i18n.t('reports.earnings')
...
async function getClients() {
    ...
    loading.value = true
    await axios.post("/reports/earnings/preview", {
...
function pdf() {
    ...
    axios.post("/reports/earnings/download", {
        clients: form.clients,
        doctitle: title,
    }, {
        responseType: 'blob'
