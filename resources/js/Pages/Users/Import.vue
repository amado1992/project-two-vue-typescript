...
<AuthenticatedLayout>
    ...
    <a href="/download/9" style="display:grid;justify-content: center;color: darkblue;margin:10px 0px">Descargar plantilla</a>
  </q-card>
        </div>
  </AuthenticatedLayout>
  </template>
  ...
  export default {
    ...
    methods: {
      ...
      submit() {
        ...
        this.$inertia.post('/importuser', formData).then( /* manejar la respuesta */ );
      }
    }
  };
  </script>