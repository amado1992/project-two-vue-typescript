    ...
    <AuthenticatedLayout>
        ...
        <div class="q-pa-md">
            ...
            <q-tr :props="props">
              ...
              >
                ...
                <template #top-right>
                    ...
                    <PrimaryButton v-if="can('create_clients', $page.props)" class="tw-ml-3" icon="add" to="clients.create"/>
                    <q-btn color="primary" v-if="can('import_clients', $page.props)" class="tw-ml-3" icon="publish" @click="open=!open"/>
            ...
            <q-dialog v-model="open">
                ...
                @finish="onFinishImport" routeName="clients.import" title="Importar plantilla de clientes"></Import>
            </q-dialog>
