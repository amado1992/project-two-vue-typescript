...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'contact_mobile' => "móvil del contacto",
        'brand' => 'marca',
        'type' => 'tipo',
        ...
        "warranty_deposit" => "depósito de garantía",
        "project_address" => "dirección del proyecto",
        "legal_representative_id" => "cédula rep. legal",
        "person_in_charge" => "persona encargada",
        "person_in_charge_id" => "cédula per. encargada",
        "seller" => "vendedor",
        "reason_id" => 'motivo',
        "client_id" => 'cliente',
        "products" => 'productos',
        ...
        'products.*.rented' => 'realquilados',
        'products.*.mesu' => 'mesu',
        'products.*.carried_by_client' => 'cantidad a retirar por el cliente',
        'book' => 'no. libreta',
        'project_manager' => 'nombre',
        'project_manager_phone' => 'teléfono',
        'construction_manager' => 'nombre',
        'construction_manager_phone' => 'teléfono',
        'in_charge_to_pay' => 'nombre',
        'in_charge_to_pay_phone' => 'teléfono',
        "updated_at" => 'fecha de actualización',
        'user_id' => 'usuario',
        'project_id' => 'proyecto',
        'billers' => 'facturadores',
        'tax_itbms' => 'impuesto ITBMS',
        'expire_at' => 'expira',
        'expire_contract_notification' => 'vencimiento de contrato',
        'product_category_id' => 'categoría padre',
        'role' => 'rol',
        'mobile' => 'móvil',
        ...
        'color' => 'color',
        'active_at' => 'iniciado',
        'active_by' => 'iniciado por',
        'finished_at' => 'finalizado',
        'finished_by' => 'finalizado por',
        'cancelled_at' => 'cancelado',
        'cancelled_by' => 'cancelado por',
        'cancelled_reason' => 'razón de la cancelación',
        'quote_id' => 'cotización',
        'contacts' => 'contactos',
        'credit' => 'crédito',
        ...
        'remainder_days' => 'vence',
        'renovation_count' => 'renovaciones', 
