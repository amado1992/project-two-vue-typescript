...
<head>
    ...
    <title>REPORTE DE RE-ALQUILERES</title>
        ...
        <table class="marginb">
            <thead>
                <tr>
                    ...
                    <td class="text-right" width="10%">Realquilados</td>
                    <td class="text-right" width="10%">Alquilados</td>
                    <td class="text-right" width="10%">Disponibles</td>
                    <td class="text-right" width="8%">Costo</td>
                </tr>
            </thead>
            <tbody>
                @foreach ($provider["items"] as $product)
                    <tr>
                        <td>{{ $product->name }}</td>
                        <td class="text-right"> {{ $product->rented + $product->disponible }}</td>
